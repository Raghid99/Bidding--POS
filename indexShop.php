...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-light">
            <div class="container">
              ...
              <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item">
                    <a class="nav-link text-dark" href="bidding/Home.php">Auction</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link text-dark" href="CarDealer/index.php">Members</a>
                  </li>
                  <li class="nav-item">
        ...
        <section class="py-5">
            <div class="container">
                <h1 class="text-center">Come to us to get your car</h1>
